...
variable "gretel_agent_iam_role_name" {
  type        = string
  nullable    = false
  description = "The AWS IAM role that will be created for the gretel agent service account."
  default     = "gretel-hybrid-agent-role"
}

variable "gretel_agent_iam_policy_name" {
  type        = string
  nullable    = false
  description = "The AWS IAM policy that will be created for the gretel agent service account's IAM role."
  default     = "gretel-hybrid-agent-policy"
}
